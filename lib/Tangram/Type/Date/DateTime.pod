...
Tangram::Type/Date/DateTime - map date & time fields
...
=head1 SYNOPSIS
   ...
   use Tangram::RawDate;
   use Tangram::RawTime;
   use Tangram::RawType/Date/DateTime;
   use Tangram::CookedType/Date/DateTime;
   use Tangram::DMType/Date/DateTime;
   use Tangram::Type::Date::Type::Date::Type::Date::TimePiece;
...
convention for a particular module.
