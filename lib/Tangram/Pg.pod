...
L<Tangram::Type::Dump::Storable> objects are first encoded with L<MIME::Base64>,
...
L<Tangram::Type::Dump::Perl> objects are stored as C<BYTEA> columns, which as
of L<DBD::Pg> 1.31, also do not get correctly escaped by the DBD
driver.  This also affects the (as-yet not fully functional)
L<Tangram::Type::Dump::YAML> back-end, which might put C<\> characters into a YAML
document.
