...
Tangram - storing objects in standard relational databases
...
common RDBMS features as links, foreign keys, and mapping tables.
...
In short, it implements one type of B<object persistence>.
