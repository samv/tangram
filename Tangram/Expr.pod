...
object. It supports the includes methods, which returns a
Tangram::Filter stating that the collection must contain the operand.
The operand may be a Tangram::Remote, a persistent object, or an
object ID.
